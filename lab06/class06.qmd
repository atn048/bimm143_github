...
> Q. Modify and improve our `generate_dna()` function to return it's generated sequence in a more standard formaat like "AGTAGTA" rather than the vector "A", "C", "G', "A"

```{r}
generate_dna <- function(len=6, fasta=TRUE) {
  
 ans <- sample(x=c("A","T","C","G"), 
...
My 9th, 10th, 11th, and 12th sequences were unique. 
